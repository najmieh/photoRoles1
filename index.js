...
mybot.on('message', message => {
    ...
    switch (command) {
        ...
        case 'mobilegraphy':
            ...
            break;
        case 'canon50mm':
            message.member.addRole(message.member.guild.roles.find("name", "canon50mm"));
            message.channel.sendMessage("you've been tagged with Canon EF 50mm!").catch(console.error);
            break;
        case 'canon10to18mm':
            message.member.addRole(message.member.guild.roles.find("name", "canon10to18mm"));
            message.channel.sendMessage("you've been tagged with Canon EF-S 10-18mm!").catch(console.error);
            break;
        case 'canon24mm':
            message.member.addRole(message.member.guild.roles.find("name", "canon24mm"));
            message.channel.sendMessage("you've been tagged with Canon EF-S 24mm!").catch(console.error);
            break;
        case 'canon85mm':
            message.member.addRole(message.member.guild.roles.find("name", "canon85mm"));
            message.channel.sendMessage("you've been tagged with Canon EF 85mm!").catch(console.error);
            break;
        case 'nikon35mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon35mm"));
            message.channel.sendMessage("you've been tagged with Nikon 35mm!").catch(console.error);
            break;
        case 'nikon50mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon50mm"));
            message.channel.sendMessage("you've been tagged with Nikon 50mm!").catch(console.error);
            break;
        case 'nikon55to300mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon55to300mm"));
            message.channel.sendMessage("you've been tagged with Nikon 55-300mm!").catch(console.error);
            break;
        case 'nikon55to200mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon55to200mm"));
            message.channel.sendMessage("you've been tagged with Nikon 55-200mm!").catch(console.error);
            break;
        case 'nikon70to300mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon70to300mm"));
            message.channel.sendMessage("you've been tagged with Nikon 70-300 mm!").catch(console.error);
            break;
        case 'nikonmicro40mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikonmicro40mm"));
            message.channel.sendMessage("you've been tagged with Nikon AF-S DX Micro-NIKKOR 40mm!").catch(console.error);
            break;
        case 'nikon85mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon85mm"));
            message.channel.sendMessage("you've been tagged with Nikon AF FX NIKKOR 85mm!").catch(console.error);
            break;
        case 'nikon18to55mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon18to55mm"));
            message.channel.sendMessage("you've been tagged with Nikon AF-S DX NIKKOR 18-55mm!").catch(console.error);
            break;
        case 'nikon18to200mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon18to200mm"));
            message.channel.sendMessage("you've been tagged with Nikon 18-200mm!").catch(console.error);
            break;
        case 'nikon18to300mm':
            message.member.addRole(message.member.guild.roles.find("name", "nikon18to300mm"));
            message.channel.sendMessage("you've been tagged with Nikon AF-S DX NIKKOR 18-300mm!").catch(console.error);
            break;
        case 'sony50mm':
            message.member.addRole(message.member.guild.roles.find("name", "sony50mm"));
            message.channel.sendMessage("you've been tagged with Sony 50mm!").catch(console.error);
            break;
        case 'editwithadobephotoshop':
            message.member.addRole(message.member.guild.roles.find("name", "EditWithAdobePhotoshop"));
            message.channel.sendMessage("you've been tagged with EditWithAdobePhotoshop!").catch(console.error);
            break;
        case 'editwithadobelightroom':
            message.member.addRole(message.member.guild.roles.find("name", "EditWithAdobeLightRoom"));
            message.channel.sendMessage("you've been tagged with EditWithAdobeLightRoom!").catch(console.error);
            break;
        case 'editwithcorel':
            message.member.addRole(message.member.guild.roles.find("name", "EditWithCorel"));
            message.channel.sendMessage("you've been tagged with EditWithCorel!").catch(console.error);
            break;
        case 'editwithmobileapps':
            message.member.addRole(message.member.guild.roles.find("name", "EditWithMobileApps"));
            message.channel.sendMessage("you've been tagged with EditWithMobileApps!").catch(console.error);
            break;
        case 'under18':
            message.member.addRole(message.member.guild.roles.find("name", "under18"));
            message.channel.sendMessage("you've been tagged with under18!").catch(console.error);
            break;
        case 'age18to25':
            message.member.addRole(message.member.guild.roles.find("name", "age18to25"));
            message.channel.sendMessage("you've been tagged with age18-23!").catch(console.error);
            break;
        case 'age26to30':
            message.member.addRole(message.member.guild.roles.find("name", "age26to30"));
            message.channel.sendMessage("you've been tagged with age18-23!").catch(console.error);
            break;
        case 'above30':
            message.member.addRole(message.member.guild.roles.find("name", "above30"));
            message.channel.sendMessage("you've been tagged with above30!").catch(console.error);
            break;
